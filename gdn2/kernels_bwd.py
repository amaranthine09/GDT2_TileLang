...
def dstate_kernel(
    ...
    def kernel(
        ...
        dUn: T.Tensor(v_shape, dtype=input_dtype), #type:ignore
        dh: T.Tensor(h_shape, dtype=input_dtype), #type:ignore
        dS0: T.Tensor(st_shape, dtype=state_dtype), #type:ignore
    ):
...
def dwy_a_kernel(
    ...
    def kernel(
        ...
        dh: T.Tensor(h_shape, dtype=input_dtype), #type:ignore
        G: T.Tensor(k_shape, dtype=gate_dtype), #type:ignore
        dW: T.Tensor(k_shape, dtype=input_dtype), #type:ignore
...
def daqk_kernel(
    ...
    def kernel(
        dO: T.Tensor(v_shape, dtype=input_dtype), #type:ignore
        Un: T.Tensor(v_shape, dtype=input_dtype), #type:ignore
        dAqk: T.Tensor(a_shape, dtype=accum_dtype), #type:ignore
    ):
...
def dwy_b_kernel(
    ...
    def kernel(
        ...
        dTm: T.Tensor(a_shape, dtype=accum_dtype), #type:ignore
    ):
        with T.Kernel(T.ceildiv(S, BS), B * H, threads=threads) as (i_s, i_bh):
            i_b, i_h = i_bh // H, i_bh % H
            t0 = i_s * BS
